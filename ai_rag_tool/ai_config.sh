...
export AI_HTTP_TIMEOUT="${AI_HTTP_TIMEOUT:-300}"
...
export AI_DORK_MAX_RESULTS="${AI_DORK_MAX_RESULTS:-8}"
export AI_MEMORY_WINDOW="${AI_MEMORY_WINDOW:-30}"
export AI_MEMORY_DECAY_HALFLIFE_DAYS="${AI_MEMORY_DECAY_HALFLIFE_DAYS:-14}"
export AI_MEMORY_BLACKLIST_FAIL_THRESHOLD="${AI_MEMORY_BLACKLIST_FAIL_THRESHOLD:-3}"
export AI_MEMORY_BLACKLIST_WINDOW_DAYS="${AI_MEMORY_BLACKLIST_WINDOW_DAYS:-30}"
export AI_MEMORY_SHARED="${AI_MEMORY_SHARED:-false}"
export AI_MEMORY_SHARED_FILE="${AI_MEMORY_SHARED_FILE:-$_AI_PROJECT_ROOT/ai_memory/memory_ai_shared.jsonl}"
